...
/*
   ...
   */
    ...
    @Query(value="select DC.* from DELIVERY_CODES_T DC where DC.ACTIVE = 'Y' AND DC.DELIVERY_CODE = :deliveryLocation and DC.DELIVERY_CODE_ID in (select ODM.DELIVERY_CODE_ID from OWN_DELIVERY_MAPPING_T ODM where ODM.OWNER_CODE_ID =:ownerCodeId and ODM.REQUESTING_INST_ID = :institutionId) ", nativeQuery = true)
