...
public class GFALasServiceUtil {
     ...
     */
    public GFARetrieveItemResponse getLASRetrieveResponse(GFARetrieveItemResponse gfaRetrieveItemResponseParam) {
     ...
     */
    public GFAEddItemResponse getLASEddResponse(GFAEddItemResponse gfaEddItemResponseParam) {
    ...
    public String convertJsonToString(Object objJson) {
        String strJson = "";
