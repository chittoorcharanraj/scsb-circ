...
public class OrganizationNameType extends SchemeValuePair {
    private static final Logger logger = LoggerFactory.getLogger(OrganizationNameType.class);
    private static final List<OrganizationNameType> VALUES_LIST = new CopyOnWriteArrayList();
