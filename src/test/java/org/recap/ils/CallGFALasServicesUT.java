 ...
 */
public class CallGFALasServicesUT extends BaseTestCase {

    private static final Logger logger = LoggerFactory.getLogger(CallGFALasServicesUT.class);
    ...
    public void testItemStatus() {
        ...
        try {
           ...
           // GFAItemStatusCheckResponse statusResponse = gfaLasService.itemStatusCheck(gfaItemStatusCheckRequest);
