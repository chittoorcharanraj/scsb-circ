...
public class GFALasImsLocationConnectorUT extends BaseTestCaseUT {
    ...
    public void heartBeatCheck() throws JsonProcessingException {
        ...
        imsConfigProperties.setImsServerStatusEndpoint("http://test:9092/lasapi/rest/lasapiSvc/lasStatus");
        imsConfigProperties.setImsServerResponseTimeoutMillis("1000");
        gfaLasImsLocationConnector.setImsConfigProperties(imsConfigProperties);
        String filterParamValue = objectMapper.writeValueAsString(gfaLasStatusCheckRequest);
        UriComponentsBuilder builder = UriComponentsBuilder.fromUriString("http://test:9092/lasapi/rest/lasapiSvc/lasStatus").queryParam(ScsbConstants.GFA_SERVICE_PARAM, filterParamValue);
        ...
        Mockito.doNothing().when(simpleClientHttpRequestFactory).setConnectTimeout(Integer.parseInt(imsConfigProperties.getImsServerResponseTimeoutMillis()));
        Mockito.doNothing().when(simpleClientHttpRequestFactory).setReadTimeout(Integer.parseInt(imsConfigProperties.getImsServerResponseTimeoutMillis()));
    ...
    public void itemStatusCheck() throws JsonProcessingException {
        ...
        IMSConfigProperties imsConfigProperties = new IMSConfigProperties();
        imsConfigProperties.setImsItemStatusEndpoint("http://test:9092/lasapi/rest/lasapiSvc/lasItemStatus");
        imsConfigProperties.setImsServerResponseTimeoutMillis("1000");
        gfaLasImsLocationConnector.setImsConfigProperties(imsConfigProperties);
        ...
        UriComponentsBuilder builder = UriComponentsBuilder.fromUriString("http://test:9092/lasapi/rest/lasapiSvc/lasItemStatus").queryParam(ScsbConstants.GFA_SERVICE_PARAM, filterParamValue);
        HttpEntity requestEntity = new HttpEntity<>(new HttpHeaders());
        Mockito.when(gfaLasImsLocationConnector.getRestTemplate()).thenReturn(restTemplate);
        Mockito.when(restTemplate.getRequestFactory()).thenReturn(simpleClientHttpRequestFactory);
        Mockito.doNothing().when(simpleClientHttpRequestFactory).setConnectTimeout(Integer.parseInt(imsConfigProperties.getImsServerResponseTimeoutMillis()));
    ...
    public void itemRetrieval() {
        ...
        IMSConfigProperties imsConfigProperties = new IMSConfigProperties();
        imsConfigProperties.setImsItemRetrievalOrderEndpoint(gfaItemRetrival);
        imsConfigProperties.setImsServerResponseTimeoutMillis("1000");
        gfaLasImsLocationConnector.setImsConfigProperties(imsConfigProperties);
    ...
    public void itemEDDRetrieval() throws JsonProcessingException {
        ...
        IMSConfigProperties imsConfigProperties = new IMSConfigProperties();
        imsConfigProperties.setImsItemRetrievalOrderEndpoint(gfaItemStatus);
        imsConfigProperties.setImsServerResponseTimeoutMillis("1000");
        imsConfigProperties.setImsItemEddOrderEndpoint(gfaItemEDDRetrival);
        gfaLasImsLocationConnector.setImsConfigProperties(imsConfigProperties);
    ...
    public void gfaPermanentWithdrawlDirect() {
        ...
        imsConfigProperties.setImsServerStatusEndpoint("http://test:9092/lasapi/rest/lasapiSvc/lasStatus");
        imsConfigProperties.setImsServerResponseTimeoutMillis("1000");
        imsConfigProperties.setImsPermanentWithdrawalDirectEndpoint(gfaItemPermanentWithdrawlDirect);
        gfaLasImsLocationConnector.setImsConfigProperties(imsConfigProperties);
    ...
    public void gfaPermanentWithdrawlInDirect() {
        ...
        imsConfigProperties.setImsServerStatusEndpoint("http://test:9092/lasapi/rest/lasapiSvc/lasStatus");
        imsConfigProperties.setImsServerResponseTimeoutMillis("1000");
        imsConfigProperties.setImsPermanentWithdrawalIndirectEndpoint(gfaItemPermanentWithdrawlInDirect);
        gfaLasImsLocationConnector.setImsConfigProperties(imsConfigProperties);
